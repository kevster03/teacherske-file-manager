...
<div style="background:#fff;border:1px solid #ccc;border-radius:8px;padding:20px;margin:20px 0">
<h3>CSV Template Download</h3>
<p>Download a CSV template with sample data for reference. CSV bulk import is planned for a future update.</p>
<a href="<?php echo admin_url('admin-post.php?action=tkm_download_template'); ?>" class="button button-primary">
